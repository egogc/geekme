                    ...
                    <tr class="woosb_tr_space">
                        ...
                        <td>
                            <div class="woosb-actions">
                                <a href="#" class="woosb_add_text button">
                                ...
                                <div class="woosb-title">
									...
									if ( $product->is_type( 'variable' ) ) {
										if ( ( WPCleverWoosb_Helper()->get_setting( 'variations_selector', 'default' ) === 'woovr' ) && class_exists( 'WPClever_Woovr' ) ) {
											...
											if ( is_array( $attributes ) && ( count( $attributes ) > 0 ) ) {
												echo '<div class="variations_form" data-product_id="' . esc_attr( absint( $product->get_id() ) ) . '" data-product_variations="' . esc_attr( $variations_attr ) . '">';
                                                    ...
                                                    <div class="variation">
                                                        ...
                                                        <div class="select">
															...
															wc_dropdown_variation_attribute_options( [
																...
																'product'          => $product,
																'show_option_none' => sprintf( /* translators: attribute name */ WPCleverWoosb_Helper()->localization( 'choose', esc_html__( 'Choose %s', 'woo-product-bundle' ) ), esc_html( wc_attribute_label( $attribute_name ) ) )
															] );
															?>
                                                        </div>
                                                    </div>
